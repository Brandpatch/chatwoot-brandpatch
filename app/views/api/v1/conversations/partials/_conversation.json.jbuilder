...
sla_applicable = (conversation.account.feature_enabled?('sla') || conversation.account.feature_enabled?('custom_sla')) &&
                 (!conversation.respond_to?(:sla_applicable?) || conversation.sla_applicable?)
