  ...
  module Voice
    class RecordingStatusService
      ...
      def perform
        ...
        call = Custom::Call.where(account_id: account.id).by_twilio_conference_sid(conference_sid).first
        return if call.blank?

        Custom::Voice::Provider::Twilio::RecordingAttachmentJob.perform_later(
          call.id,
          recording_sid,
          recording_url,
          recording_duration
